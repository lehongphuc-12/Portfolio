        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
              Senior Creative Developer specializing in building exceptional digital experiences. 
              Blending technical mastery with artistic vision to create pixel-perfect interfaces.
            </p>

            <div className="flex flex-wrap items-center gap-4 pt-4">
              <a href="#projects" className="group relative px-8 py-4 bg-white text-slate-950 rounded-full font-semibold overflow-hidden">
              ...
              <a href="#contact" className="px-8 py-4 rounded-full border border-white/10 hover:bg-white/5 transition-colors text-white font-medium">
                Contact Me
              </a>
            </div>
            ...
            <div className="flex items-center gap-6 pt-8 text-slate-500">
              ...
              <a href="#" className="hover:text-white transition-colors transform hover:scale-110"><Twitter size={24} /></a>
            </div>
          </motion.div>
